...
<body>
                ...
                <select id="cmbStructureId">

						<?php foreach($libraries as $library){ 
								  if($library['type']!=$libraryType){ 
						?>                        	
                                <optgroup  label="<?php echo ($library['type']); ?>">
                        <?php 	  } 
								  $libraryType = $library['type'];
						?>             	
                                	<option value="<?php echo md5($library['librariesId']); ?>"><?php echo $library['displayName'].' ('.$library['type'].')'; ?></option>
                ...
                <input type="hidden" id="shortcutCode" 	name="shortcutCode" value=""/>
