                            ...
                            <div class="inner resize clearfix">
                                <div class="inner-header clearfix">
                                    <div class="title-bar">
                                        ...
                                        <h3><?php echo $sectionDescription; ?></h3>
                                    </div>
        
                                    <div class="date-box">
                                        <p>Última actualización: <?php echo $sectionUpdate; ?></p>
                                        <p>Fecha Ult. Publicación: <?php echo $sectionFrontDate; ?></p>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="container">
														...
														<?php $k=1; foreach($lines as $line){ ?>
                                                            <div id="line-<?php echo $k; ?>-delete">
                                                                    <a class="cms-btn delete-btn" onclick='removeLine(<?php echo $k++; ?>);' href="#delete">Borrar</a>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div><!-- Column 3 end -->
                                    ...
                                    <div class="framework">
                                        <div class="container">
											<?php foreach($commands as $command){ ?>
                                                <div id="shortcut-tooltip" alt="<?php echo $command['description']; ?>">
