                   ...
                   <div class="teaser">
                       <div class="inner-showcase-container dropshadow">
                           ...
                           <?php /*Find*/foreach($tendencias_elements as $tendencias_element): ?>
                               <img src="<?php echo base_url()."/uploads"; ?><?php echo $tendencias_element[$fieldTags["fieldName"]]["data"]; ?>" alt="" />                          
                           <!-- Etiqueta endfindelements no definida -->                           <img src="img/tendencia/tendencia-escaparate-interior.jpg" alt="" />
                       </div>
