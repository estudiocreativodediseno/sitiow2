     ...
     <body>
         <div class="wrap main-content box">
             <div class="header dropshadow">
                 <h1><a href="index.html" class="replacement brand">CASA | PALACIO</a></h1>
                 ...
                 <ul class="nav main-menu right">
                     ...
                     <li><a href="catalogo-listado.html">Catálogo de temporada</a></li>
             ...
             <div class="teaser">
                 <div class="brand-detail">
                     ...
                     <div class="review-item clearfix">
                         <div class="frame-box">
                             <div class="frame"><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/marcas/marca-detalle-01.jpg" width="411" height="455" /></div>
                         </div>
                     ...
                     <div class="collection-gallery">
                         ...
                         <div id="gallery-showcase" class="collection-showcase">
                             <div class="collection-item">
                                 ...
                                 <img src="<?php echo base_url()."uploads/files/resources"; ?>/img/marcas/colleccion-01.jpg" width="960" height="530" />
                             </div>
