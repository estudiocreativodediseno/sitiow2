         ...
         <div class="wrap main-content box">
             <div class="header dropshadow">
                 ...
                 <ul class="nav main-menu right">
                     ...
                     <li><a href="marcas-categoria.html">Marcas &amp; Diseñadores</a></li>
             ...
             <div class="teaser">
                 <div class="brand-detail">
                     <div class="gallery-header clearfix">
                         <div class="tagline">
                             <h2 class="ribbon short"><a href="catalogo-listado.html">Escaparate</a></h2>
                         </div>
 
                         <a href="catalogo-listado.html" class="txt-link layer" style="clear: both">Regresar a stock</a>
                     </div>
