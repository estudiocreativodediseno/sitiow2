 ...
 <html xmlns="http://www.w3.org/1999/xhtml">
						...
						<?php 		echo $libraries;	?>
                                             ...
                                             <div class="wrap main-content box">
                                                 <div class="header">
                                                     ...
                                                     <ul class="nav main-menu right">
                                                         ...
                                                         <li><a href="<?php echo substr(base_url(),0,strlen(base_url())-1).$urlSections["o"].""; ?>">Marcas &amp; Diseñadores</a></li>
                               ...
                               <li><img src="<?php echo base_url()."/uploads"; ?><?php echo $escaparatePrincipal_element[$fieldTags["imagen"]]["data"]; ?>" alt="" /></li>
                                       <?php endforeach; ?>
                                                     </ul>
