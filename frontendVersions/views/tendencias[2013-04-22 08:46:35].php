              ...
              <body>
                      ...
                      <div class="teaser">
                          <div class="inner-showcase-container dropshadow">
                              ...
                              <?php /*Find*/ foreach($tendencias_elements as $tendencias_element): ?>
                                  <img src="<?php echo base_url()."/uploads"; ?><?php echo $tendencias_element[$fieldTags["escaparat"]]["data"]; ?>" alt="" />                          
                  ...
                  <?php /*Find*/ foreach($tendencias_elements as $tendencias_element): ?>
                      ...
                      <div class="marketing-zone dropshadow">
                          <a href="#"><img src="<?php echo base_url()."/uploads"; ?><?php echo $tendencias_element[$fieldTags["fieldName"]]["data"]; ?>" width="990" height="90" alt="" /></a>
