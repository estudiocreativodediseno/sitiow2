                    ...
                    <?php /*Find*/ foreach($tendencias_elements as $tendencias_element): ?>
                            <div class="concept">
                                <div class="tagline">
                                    ...
                                    <h3><?php echo $tendencias_element[$fieldTags["fieldName"]]["data"]; ?> <br /><span><?php echo $tendencias_element[$fieldTags["fieldName"]]["data"]; ?></span></h3>
                                </div>
                                
                                <div class="article right">
                                    <h4><?php echo $tendencias_element[$fieldTags["fieldName"]]["data"]; ?></h4>
            
                                    <p<?php echo $tendencias_element[$fieldTags["fieldName"]]["data"]; ?>></p>
