      ...
      <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <?php foreach($_elements as $_element): ?>
<li><img src="<?php echo base_url()."uploads/files/resources"; ?><?php echo $escaparate principal_element[$fieldTags->fieldName]["data"]; ?>" /></li>
<li><img src="<?php echo base_url()."uploads/files/resources"; ?><?php echo $escaparate principal_element[$fieldTags->fieldName]["data"]; ?>" /></li><?php echo $escaparate principal_element[$fieldTags->fieldName]["data"]; ?>        <?php endforeach; ?>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/escaparate/t1.jpg" /></li>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/escaparate/t2.jpg" /></li>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/escaparate/t1.jpg" /></li>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/escaparate/t2.jpg" /></li>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/escaparate/t1.jpg" /></li>
                      </ul>
                  ...
                  <div class="panel clearfix">
                      <div class="teaser left">
                          <div class="featured-banner interiorismo">
                              <ul id="interiorismo">
                                  <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/banners/banner-kenzo.jpg" alt="" /></li>
                                  <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/banners/banner-video-audio.jpg" alt="" /></li>
                              </ul>
                          </div>
                      ...
                      <div class="featured-products box right">
                          ...
                          <ul id="productos-tendencia" class="featured-showcase">
                              <li><a href="catalogo-listado.html"><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/destacados/destacados-01.jpg" alt="" /></a></li>
                              <li><a href="catalogo-listado.html"><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/destacados/destacados-01.jpg" alt="" /></a></li>
                              <li><a href="catalogo-listado.html"><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/destacados/destacados-01.jpg" alt="" /></a></li>
                          </ul>
                      </div>
