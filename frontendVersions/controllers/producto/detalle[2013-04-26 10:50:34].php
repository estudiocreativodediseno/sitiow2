...
class Detalle extends CI_Controller {			
    ...
    function __construct(){
        ...
        $this->title = "Detalle Producto - Detalles del producto";
    }
    

  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [2013-04-26 10:49:54]
	 ...
	 */
     function index(){
		...
		';
			...
			$output->title = 'Detalle Producto - Detalles del producto';
			$output->url_section = base_url().'index.php/producto/detalle';
			
			/* Se carga la vista del Controlador*/
			$this->load->view('/producto/detalle', $output);
		}catch(Exception $e){
	 ...
	 * Búsqueda por id: Detalle Producto - Detalles del producto
	 *
	 * @return void
	 */
     function id($valueId){
		try{
			...
			$output->title = 'Detalle Producto - Detalles del producto';
			$output->url_section = base_url().'/producto/detalle';
			/* Se carga la vista del Controlador*/
			$this->load->view('/producto/detalle', $output);
		}catch(Exception $e){
			  /* En caso de error, lo mostramos */
...
/* Location: ./application/controllers/producto/detalle.php */
