...
class Productos extends CI_Controller {			
    ...
    function __construct(){
        ...
        $this->title = "Productos - Productos de la temporada";
    }
    

  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [2013-04-16 09:05:13]
	 * Productos - Productos de la temporada
	 *
	 * @return void
	 */
     function index(){
		...
		';
			...
			$output->title = 'Productos - Productos de la temporada';
			$output->url_section = base_url().'index.php/productos';
	 ...
	 * Búsqueda por id: Productos - Productos de la temporada
	 *
	 * @return void
	 */
     function id($valueId){
		try{
			...
			$output->fieldTags = $fieldTags;
			$output->title = 'Productos - Productos de la temporada';
			$output->url_section = base_url().'/productos';
			/* Se carga la vista del Controlador*/
			$this->load->view('/productos', $output);
		}catch(Exception $e){
			  /* En caso de error, lo mostramos */
