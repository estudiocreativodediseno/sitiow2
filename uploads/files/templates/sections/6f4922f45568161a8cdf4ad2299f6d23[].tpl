...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="scripts/libraries/jquery.bxSlider.js"></script>
		<!--<script type="text/javascript" src="scripts/libraries/jquery.actual.min.js"></script>-->
			...
			<div class="teaser">
				<div class="brand-detail">
					...
					<div class="review-item clearfix">
						<div class="frame-box">
							<div class="frame"><img src="img/marcas/marca-detalle-02.jpg" width="411" height="455" /></div>
						</div>
					...
					<div id="catalog-showcase" class="catalog-showcase">
						...
						<div class="catalog-slide clearfix">
							<a href="detalle-producto.html" class="gallery-item catalog-item">
								<span>
									<strong>
										<img src="img/marcas/sample-img-01.jpg" width="215" height="198" />
										<q>Lámpara aurin</q>
							...
							<a href="detalle-producto.html" class="gallery-item catalog-item">
								<span>
									<strong>
										<img src="img/marcas/sample-img-02.jpg" width="215" height="198" />
										<q>Lámpara aurin</q>
										<em>Sofisticado diseño de Kenzo, ideal para el estudio en casa.</em>
									</strong>
								</span>
							...
							<a href="detalle-producto.html" class="gallery-item catalog-item">
								<span>
									<strong>
										<img src="img/marcas/sample-img-03.jpg" width="215" height="198" />
										<q>Lámpara aurin</q>
										<em>Sofisticado diseño de Kenzo, ideal para el estudio en casa.</em>
									</strong>
								</span>
