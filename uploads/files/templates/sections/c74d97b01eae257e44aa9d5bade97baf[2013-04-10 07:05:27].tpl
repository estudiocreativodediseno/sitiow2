  ...
  <li><a href="{%url-section sectionId='9bf31c7ff062936a96d3c8bd1f8f2ff3' parameters=''%}"><img src="{%url-resources-folder%}/img/destacados/destacados-01.jpg" alt="" /></a></li>
         {%end-loop%}        {%end-loop%}                                 <li><a href="{%url-section sectionId='9bf31c7ff062936a96d3c8bd1f8f2ff3' parameters=''%}"><img src="{%url-resources-folder%}/img/destacados/destacados-01.jpg" alt="" /></a></li>
                                 <li><a href="{%url-section sectionId='9bf31c7ff062936a96d3c8bd1f8f2ff3' parameters=''%}"><img src="{%url-resources-folder%}/img/destacados/destacados-01.jpg" alt="" /></a></li>
                                 <li><a href="{%url-section sectionId='9bf31c7ff062936a96d3c8bd1f8f2ff3' parameters=''%}"><img src="{%url-resources-folder%}/img/destacados/destacados-01.jpg" alt="" /></a></li>
                             </ul>
                         </div>
