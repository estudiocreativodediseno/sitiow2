                    ...
                    {%find-elements name='findName' maxElements='' rowsPerPage='' structureId='3c59dc048e8850243be8079a5c74d079' whereFieldId='f457c545a9ded88f18ecee47145a72c0' condition='=,>,<,<>,LIKE' value=''%}
                            <div class="concept">
                                <div class="tagline">
                                    ...
                                    <h3>Concepto e inspiración <br /><span>en tendencia</span></h3>
                                </div>
                                
                                <div class="article right">
                                    <h4>Lorem ipsum dolor sit amet, consectetur adip iscing elit. Integer sit amet gravida sapien. Quisque elementum, enim ut consequat suscipit, orci sapien tincidunt justo.</h4>
            
                                    <p>Vestibulum ut nulla iaculis libero tristique vestibulum. In condimentum interdum nibh, eu dictum tortor facilisis consectetur. Praesent pretium imperdiet hendrerit. Duis vitae fermentum nunc. Quisque mattis nibh quis odio tristique ultricies pellentesque non nulla. Integer ut justo at elit lacinia egestas nec et lacus.</p>
            
                                    <p>Nunc non dui sed risus lacinia aliquet nec vitae est. Suspendisse varius venenatis lacus, quis rutrum risus faucibus ut. Morbi pellentesque tempor tellus, sed condimentum lacus euismod non. Maecenas commodo nunc sed odio vehicula rutrum. Nunc vitae pulvinar odio. Quisque non eros vel lacus.</p>
                                </div>
                            </div>
