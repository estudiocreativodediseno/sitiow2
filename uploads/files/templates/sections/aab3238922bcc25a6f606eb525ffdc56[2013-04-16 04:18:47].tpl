             ...
             <div class="board">
                 <div class="inner-showcase-container slider dropshadow">
                     <ul id="inner-showcase" class="inner-showcase layer">
                         <li><img src="img/interiores/marcas-disenadores-escaparate-interior-03.jpg" alt="" /></li>
                         <li><img src="img/interiores/marcas-disenadores-escaparate-interior-02.jpg" alt="" /></li>
                         <li><img src="img/interiores/marcas-disenadores-escaparate-interior-01.jpg" alt="" /></li>
