...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="styles/tendencia.css" />
		<link rel="stylesheet" type="text/css" href="styles/interior.css" />

		<script type="text/javascript" src="scripts/libraries/jquery-1.7.2.js"></script>

		<script type="text/javascript" src="scripts/libraries/jquery.bxSlider.min.js"></script>
		<script type="text/javascript" src="scripts/tools-manager.js"></script>
			...
			<div class="teaser">
				<div class="brand-detail">
						...
						<div class="custom-search">
							<form id="" action="" method="post">
								<fieldset class="component-search clearfix">
									<label for="">¿Buscas algo en especial? <span>Escríbelo aquí&hellip;</span></label>
					...
					<div class="review-item clearfix">
						<div class="frame-box">
							<div class="frame"><img src="img/marcas/marca-detalle-01.jpg" width="411" height="455" /></div>
						</div>
						...
						<div class="mini-social-box layer">
							...
							<div class="widget-container">
								...
								<div class="widget-item facebook">
									<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.casapalacio.com.mx&amp;send=false&amp;locale=en_US&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font=lucida+grande&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe>
								</div>

								<!-- Twitter Plugin -->
								<div class="widget-item twitter">
									<a href="https://twitter.com/share" class="twitter-share-button" data-count="none" data-via="casa_palacio" data-url="" data-text="" data-hashtags="" data-lang="en">Tweet</a>
									<script type="text/javascript" src="scripts/plugins/twitter-plugin.js"></script>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="collection-gallery">
						...
						<div id="gallery-showcase" class="collection-showcase">
							<div class="collection-item">
								...
								<img src="img/marcas/colleccion-01.jpg" width="960" height="530" />
							</div>
