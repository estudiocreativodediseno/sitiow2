    ...
    <li><img src="{%url-resources-folder%}/img/banners/banner-video-audio.jpg" alt="" /></li><li><img src="{%url-resources-folder%}/img/banners/banner-video-audio.jpg" alt="" /></li>                                    </ul>
                                </div>
                            </div>
