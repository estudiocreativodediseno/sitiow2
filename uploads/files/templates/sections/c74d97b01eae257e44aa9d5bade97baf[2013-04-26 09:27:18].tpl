 ...
 <html xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        {%insert-libraries%}
                               ...
                               <li><img src="{%url-uploads-folder%}{%element.imagen structureId='c74d97b01eae257e44aa9d5bade97baf' fieldId='f7177163c833dff4b38fc8d2872f1ec6'%}" alt="" /></li>
                                       {%end-loop%}
                                                     </ul>
                                                         ...
                                                         <div class="featured-banner interiorismo">
                                                             <ul id="interiorismo">
                                                                 {%start-loop name='loopName' maxElements='' rowsPerPage='' structureId='6f4922f45568161a8cdf4ad2299f6d23'%}
                                                                     <li><img src="{%url-uploads-folder%}{%element.fieldName structureId='6f4922f45568161a8cdf4ad2299f6d23' fieldId='67c6a1e7ce56d3d6fa748ab6d9af3fd7'%}" alt="" /></li>   
                                                                 {%end-loop%}
                                                             </ul>
                                                         </div>
                                                         ...
                                                         <div class="featured-banner destacados">
                                                             <ul id="destacados">
                                                                 {%start-loop name='loopName' maxElements='' rowsPerPage='' structureId='70efdf2ec9b086079795c442636b55fb'%}
                                                                     <li><img src="{%url-uploads-folder%}{%element.fieldName structureId='70efdf2ec9b086079795c442636b55fb' fieldId='67c6a1e7ce56d3d6fa748ab6d9af3fd7'%}" alt="" /></li>   
                                                                 {%end-loop%}   
                                                             </ul>
                                                          </div>
                                                     </div>
                                                     ...
                                                     <div class="featured-products box right">
                                                         ...
                                                         <ul id="productos-tendencia" class="featured-showcase">
                                                             {%start-loop name='loopName' maxElements='' rowsPerPage='' structureId='1f0e3dad99908345f7439f8ffabdffc4'%}
                                                                <li><a href="{%element.fieldName structureId='1f0e3dad99908345f7439f8ffabdffc4' fieldId='d9d4f495e875a2e075a1a4a6e1b9770f'%}"><img src="{%url-uploads-folder%}{%element.fieldName structureId='1f0e3dad99908345f7439f8ffabdffc4' fieldId='67c6a1e7ce56d3d6fa748ab6d9af3fd7'%}" alt="" /></a></li>
                                                             {%end-loop%} 
                                                         </ul>
                                                     </div>
                                                 </div>
