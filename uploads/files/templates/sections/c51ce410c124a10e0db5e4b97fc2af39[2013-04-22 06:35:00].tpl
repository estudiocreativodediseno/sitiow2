                  ...
                  <div class="teaser">
                      <div class="inner-showcase-container dropshadow">
                          ...
                          {%find-elements name='findName' maxElements='' rowsPerPage='' structureId='3c59dc048e8850243be8079a5c74d079' whereFieldId='f457c545a9ded88f18ecee47145a72c0' condition='=,>,<,<>,LIKE' value=''%}
                              <img src="{%url-uploads-folder%}{%element.fieldName structureId='3c59dc048e8850243be8079a5c74d079' fieldId='f457c545a9ded88f18ecee47145a72c0'%}" alt="" />                          {%end-find-elements%}
