           ...
           <li><img src="{%url-uploads-folder%}{%element.imagen structureId='c74d97b01eae257e44aa9d5bade97baf' fieldId='f7177163c833dff4b38fc8d2872f1ec6'%}" /></li>
                 ...
                 {%end-loop%}
                                     ...
                                     <div class="featured-banner destacados">
                                         <ul id="destacados">
                 {%start-loop name='loopName' maxElements='' rowsPerPage='' structureId='70efdf2ec9b086079795c442636b55fb'%}
70efdf2ec9b086079795c442636b55fb                                           <li><img src="{%url-uploads-folder%}{%element.fieldName structureId='70efdf2ec9b086079795c442636b55fb' fieldId='67c6a1e7ce56d3d6fa748ab6d9af3fd7'%}" alt=""/></li>   
70efdf2ec9b086079795c442636b55fb                 {%end-loop%}   </ul>                                 </div>
                                 </div>
{%element.fieldName structureId='70efdf2ec9b086079795c442636b55fb' fieldId='67c6a1e7ce56d3d6fa748ab6d9af3fd7'%}
