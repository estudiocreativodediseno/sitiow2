             ...
             <div class="teaser">
                 <div class="brand-detail">
                     ...
                     <div class="review-item clearfix">
                         <div class="frame-box">
                             <div class="frame"><img src="{%url-resources-folder%}/img/marcas/marca-detalle-01.jpg" width="411" height="455" /></div>
                         </div>
                     ...
                     <div class="collection-gallery">
                         ...
                         <div id="gallery-showcase" class="collection-showcase">
                             <div class="collection-item">
                                 ...
                                 <img src="{%url-resources-folder%}img/marcas/colleccion-01.jpg" width="960" height="530" />
                             </div>
