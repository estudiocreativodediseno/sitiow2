...
<li><img src="{%url-resources-folder%}{%element.fieldName structureId='c74d97b01eae257e44aa9d5bade97baf' fieldId='f7177163c833dff4b38fc8d2872f1ec6'%}" /></li>
<li><img src="{%url-resources-folder%}{%element.fieldName structureId='c74d97b01eae257e44aa9d5bade97baf' fieldId='f7177163c833dff4b38fc8d2872f1ec6'%}" /></li>{%element.fieldName structureId='c74d97b01eae257e44aa9d5bade97baf' fieldId='f7177163c833dff4b38fc8d2872f1ec6'%}        {%end-loop%}
                          <li><img src="{%url-resources-folder%}/img/escaparate/t1.jpg" /></li>
                          <li><img src="{%url-resources-folder%}/img/escaparate/t2.jpg" /></li>
                          <li><img src="{%url-resources-folder%}/img/escaparate/t1.jpg" /></li>
                          <li><img src="{%url-resources-folder%}/img/escaparate/t2.jpg" /></li>
                          <li><img src="{%url-resources-folder%}/img/escaparate/t1.jpg" /></li>
                      </ul>
                  ...
                  <div class="panel clearfix">
                      <div class="teaser left">
                          <div class="featured-banner interiorismo">
                              <ul id="interiorismo">
                                  <li><img src="{%url-resources-folder%}/img/banners/banner-kenzo.jpg" alt="" /></li>
                                  <li><img src="{%url-resources-folder%}/img/banners/banner-video-audio.jpg" alt="" /></li>
                              </ul>
                          </div>
