                   ...
                   <body>
                       ...
                       <?php /*Find*/ foreach($tendencias_elements as $tendencias_element): ?>
                               ...
                               <div class="season-products">
                                   <div class="tagline">
                                       <h2 class="ribbon"><?php echo $tendencias_element[$fieldTags["col_titulo"]]["data"]; ?></h2>
                                       <h3><?php echo $tendencias_element[$fieldTags["col_sub1"]]["data"]; ?> <br /><span><?php echo $tendencias_element[$fieldTags["col_sub2"]]["data"]; ?></span></h3>
                                   </div>
                                   
                                   <div class="article left">
                                       <h4><?php echo $tendencias_element[$fieldTags["col_desc1"]]["data"]; ?></h4>
               
                                       <p><?php echo $tendencias_element[$fieldTags["col_desc2"]]["data"]; ?></p>
                                   </div>
                               ...
                               <div class="season-advice">
                                   <div class="tagline">
                                       <h2 class="ribbon"><?php echo $tendencias_element[$fieldTags["sig_titulo"]]["data"]; ?></h2>
                                       <h3><?php echo $tendencias_element[$fieldTags["sig_sub1"]]["data"]; ?><br /><span><?php echo $tendencias_element[$fieldTags["sig_sub2"]]["data"]; ?></span></h3>
                                   </div>
               
                                   <div class="article left">
                                       <h5><?php echo $tendencias_element[$fieldTags["sig_desc1"]]["data"]; ?></h5>
                                       <p><?php echo $tendencias_element[$fieldTags["sig_desc2"]]["data"]; ?></p>
