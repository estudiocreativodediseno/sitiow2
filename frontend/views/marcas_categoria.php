          ...
          <div class="wrap main-content box">
              <div class="header">
                  ...
                  <ul class="nav main-menu right">
                      ...
                      <li><a href="<?php echo substr(base_url(),0,strlen(base_url())-1).$urlSections["aab3238922bcc25a6f606eb525ffdc56"].""; ?>" class="current">Marcas &amp; Diseñadores</a></li>
                      ...
                      <div id="brands-category" class="gallery-container">
                          ...
                          <div class="gallery-showcase clearfix">
                              <a href="marcas-listado.html" class="gallery-item brands-category">
                                  <span>
                                      <img src="<?php echo base_url()."uploads/files/resources"; ?>/img/core/ui/overlay-bg.png" width="270" height="160" />
                                      <q>Vivir &amp; Disfrutar</q>
              ...
              <div class="marketing-banner">
                  <a href="#"><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/marketing/banner-marketing-01.jpg" alt=""></a>
              </div>
