              ...
              <div class="board">
                  <div class="inner-showcase-container slider dropshadow">
                      <ul id="inner-showcase" class="inner-showcase layer">
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/interiores/marcas-disenadores-escaparate-interior-03.jpg" alt="" /></li>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/interiores/marcas-disenadores-escaparate-interior-02.jpg" alt="" /></li>
                          <li><img src="<?php echo base_url()."uploads/files/resources"; ?>/img/interiores/marcas-disenadores-escaparate-interior-01.jpg" alt="" /></li>
                  ...
                  <div class="gallery-panel clearfix">
                      <div class="gallery-header clearfix">
                          <div class="tagline">
                              <h2 class="ribbon short"><a href="<?php echo substr(base_url(),0,strlen(base_url())-1).$urlSections["aab3238922bcc25a6f606eb525ffdc56"].""; ?>">Showroom</a></h2>
                      ...
                      <div id="brands" class="gallery-container">
                          ...
                          <div class="gallery-showcase clearfix">
                              <a href="marcas-detalle.html" class="gallery-item brands">
                                  <span>
                                      <img src="<?php echo base_url()."uploads/files/resources"; ?>/img/core/ui/overlay-bg.png" width="189" height="140" />
                          ...
                          <div class="gallery-showcase clearfix">
                              ...
                              <a href="marcas-detalle.html" class="gallery-item brands">
                                  <span>
                                      <img src="img/core/ui/overlay-bg.png" width="189" height="140" />
                                      <em>Lorem ipsum colores greatest</em>
                                  </span>
                              </a>
