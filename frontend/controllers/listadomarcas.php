...
class Listadomarcas extends CI_Controller {			
    ...
    function __construct(){
        ...
        $this->title = "Listado de Marcas - Listado de Marcas";
    }
    

  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [2013-04-17 09:19:06]
	 * Listado de Marcas - Listado de Marcas
	 *
	 * @return void
	 */
     function index(){
		...
		';
			...
			$output->title = 'Listado de Marcas - Listado de Marcas';
			$output->url_section = base_url().'index.php/listadomarcas';
			
			/* Se carga la vista del Controlador*/
			$this->load->view('/listadomarcas', $output);
		}catch(Exception $e){
	 ...
	 * Búsqueda por id: Listado de Marcas - Listado de Marcas
	 *
	 * @return void
	 */
     function id($valueId){
		try{
			...
			$output->title = 'Listado de Marcas - Listado de Marcas';
			$output->url_section = base_url().'/listadomarcas';
			/* Se carga la vista del Controlador*/
			$this->load->view('/listadomarcas', $output);
		}catch(Exception $e){
			  /* En caso de error, lo mostramos */
...
/* End of file Listadomarcas.php */
/* Location: ./application/controllers/listadomarcas.php */
