// JavaScript Document
	...
	function editPermission(type,groupId,moduleId){
		$.post($('#base-url').val()+"admin.php/config/access/userGroups/editModulePermission", 
				{	
					'groupId': 	groupId,
					'moduleId': moduleId,
					'type': 	type
				...
				function(data){
					...
					createGrowl('Cambio realizado', response.message, false);
	...
	function editFunctionAllowed(type,groupId,functionId){
		$.post($('#base-url').val()+"admin.php/config/access/userGroups/editFunctionAllowed", 
				{	
					'groupId': 		groupId,
